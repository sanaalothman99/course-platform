    ...
    <main className="min-h-screen bg-[#0a0f1e] text-white">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-1">{t("totalOrdersCount", { count: orders.length })}</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10 bg-white/5">
                <th className="text-left px-6 py-4 text-gray-400 text-sm">{t("colStudent")}</th>
                ...
                <th className="text-left px-6 py-4 text-gray-400 text-sm">{t("colDate")}</th>
              </tr>
            </thead>
            <tbody>
              {loading && (
                <tr>
                  <td colSpan={4} className="px-6 py-8 text-center text-gray-400">{tc("loading")}</td>
                </tr>
              )}
              {!loading && orders.length === 0 && (
                <tr>
                  <td colSpan={4} className="px-6 py-8 text-center text-gray-400">{t("noOrders")}</td>
                </tr>
              )}
              {orders.map((order) => (
